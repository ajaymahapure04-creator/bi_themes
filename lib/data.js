...
export const DOMAINS = {
  workforce: {
    ...
    kpis: [
      { label: "Total Headcount", value: "7,214", delta: "+3.2%", isGood: true },
      { label: "Bench Strength", value: "612", delta: "-8.4%", isGood: true },
      { label: "Utilization", value: "87.6%", delta: "+1.9%", isGood: true },
      { label: "Open Demands", value: "1,038", delta: "+12%", isGood: false },
    ],
  ...
  automotive: {
    ...
    kpis: [
      { label: "Vehicles Online", value: "1.82M", delta: "+4.1%", isGood: true },
      { label: "OTA Success Rate", value: "96.3%", delta: "+0.8%", isGood: true },
      { label: "Active Campaigns", value: "47", delta: "+6", isGood: true },
      { label: "Avg. Install Time", value: "18m", delta: "-2m", isGood: true },
    ],
  ...
  finance: {
    ...
    kpis: [
      { label: "Revenue YTD", value: "€48.2M", delta: "+11.4%", isGood: true },
      { label: "Gross Margin", value: "34.8%", delta: "+2.1pp", isGood: true },
      { label: "OPEX", value: "€9.6M", delta: "+4.0%", isGood: false },
      { label: "DSO", value: "52 days", delta: "-6", isGood: true },
    ],
  ...
  sales: {
    ...
    kpis: [
      { label: "Pipeline", value: "$12.4M", delta: "+18%", isGood: true },
      { label: "Win Rate", value: "31.2%", delta: "+2.4pp", isGood: true },
      { label: "Avg. Deal Size", value: "$86K", delta: "-4%", isGood: false },
      { label: "Quota Attainment", value: "92%", delta: "+7pp", isGood: true },
    ],
  ...
  supply: {
    ...
    kpis: [
      { label: "OTIF", value: "94.1%", delta: "+1.2%", isGood: true },
      { label: "Inventory Value", value: "$8.2M", delta: "-6%", isGood: true },
      { label: "Stockouts", value: "23", delta: "-11", isGood: true },
      { label: "Lead Time", value: "12.4d", delta: "+0.8d", isGood: false },
    ],
  ...
  marketing: {
    ...
    kpis: [
      { label: "Active users", value: "79K", delta: "+20.2%", isGood: true },
      { label: "New users", value: "72K", delta: "+21.9%", isGood: true },
      { label: "Sessions", value: "131K", delta: "+16.9%", isGood: true },
      { label: "Duration (seconds)", value: "298.65", delta: "-6.5%", isGood: false },
      { label: "Key events", value: "9K", delta: "+14.6%", isGood: true },
      { label: "Engaged sessions", value: "68K", delta: "+17.9%", isGood: true },
      { label: "Engagement rate", value: "51.68%", delta: "+0.43pp", isGood: true },
    ],
