// Power BI built-in base theme (CY26SU05), shipped verbatim so the generated
// report.json can reference a baseTheme exactly like a real Desktop-authored
// .pbip -- Desktop layers our custom theme on top of this. Captured from a
// real Desktop save; do not hand-edit.
export const BASE_THEME_NAME = "CY26SU05";
export const BASE_THEME_JSON = {
  "name": "CY26SU05",
  "dataColors": [
    "#118DFF",
    "#12239E",
