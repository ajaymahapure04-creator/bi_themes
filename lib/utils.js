// Pure direction signal from a KPI delta string ("+3.2%", "-8.4%", "+6", "-2m",
// "+0.8d", "+2.1pp") -- deliberately independent of whether the change is good
// or bad for the business (that's the KPI's own isGood flag, used for color).
// The arrow always follows the number's actual sign, never business semantics.
